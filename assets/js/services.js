...
var ApplicationDbContext = {
    "init": function(connectionStr) {
        ...
        // Get the sored data with the key. If the data is not present in the localstorage --> store the previous data from the variable 
        //_dbData into the localstorage via the connection string or namespace
